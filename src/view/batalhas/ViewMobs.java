 ...
 * @author 422UR4H
 */
public class ViewMobs extends javax.swing.JFrame {
    ...
    public ViewMobs() {
        ...
        for (String nome : AlgoritmoPrincipal.getFichas().keySet()) {
            ...
            valores[2] = AlgoritmoPrincipal.getPerson(nome).getHpMax();
            dtm.addRow(valores);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewMobs.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
