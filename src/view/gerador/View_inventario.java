...
public class View_inventario extends javax.swing.JDialog {
    ...
    public View_inventario(java.awt.Frame parent, boolean modal) {
        ...
        this.setTitle(AlgoritmoPrincipalGerador.getFicha().getNick());
        jTextArea.setText(AlgoritmoPrincipalGerador.getFicha().getInventario());
    ...
    private void jButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonActionPerformed
        AlgoritmoPrincipalGerador.getFicha().setInventario(jTextArea.getText());
        // salvando a ficha
