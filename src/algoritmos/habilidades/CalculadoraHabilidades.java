 ...
 * @author 422UR4H
 */
public class CalculadoraHabilidades {
    private static final Map<String, Armas> ARMAS = new HashMap<>();
    private static final Map<String, Armas> ELEMENTOS = new HashMap<>(); // trocar o nome de Armas
    ...
    public static void init() {
        ...
        Armas fogo = new Armas();
        fogo.setNome("Fogo");
        fogo.setDados("D12");
        ELEMENTOS.put(fogo.getNome(), fogo);
        
        Armas raio = new Armas();
        raio.setNome("Raio");
        raio.setDados("D12");
        ELEMENTOS.put(raio.getNome(), raio);
        
        Armas acido = new Armas();
        acido.setNome("Acido");
        acido.setDados("D12");
        ELEMENTOS.put(acido.getNome(), acido);
        
        Armas trevas = new Armas();
        trevas.setNome("Trevas");
        trevas.setDados("D12");
        ELEMENTOS.put(trevas.getNome(), trevas);
        
        Armas madeira = new Armas();
        madeira.setNome("Madeira");
        madeira.setDados("D10");
        madeira.setDano(1);
        ELEMENTOS.put(madeira.getNome(), madeira);
        
        Armas gelo = new Armas();
        gelo.setNome("Gelo");
        gelo.setDados("D10");
        gelo.setDano(1);
        ELEMENTOS.put(gelo.getNome(), gelo);
        
        Armas terra = new Armas();
        terra.setNome("Terra");
        terra.setDados("D10");
        terra.setDano(1);
        ELEMENTOS.put(terra.getNome(), terra);
        
        Armas metal = new Armas();
        metal.setNome("Metal");
        metal.setDados("D10");
        metal.setDano(1);
        ELEMENTOS.put(metal.getNome(), metal);
        ...
        Armas metal1 = new Armas();
        metal1.setNome("Metal 1");
        metal1.setDados("D10");
        metal1.setDano(1);
        ARMAS.put(metal1.getNome(), metal1);
        ...
        Armas madeira2 = new Armas();
        madeira2.setNome("Madeira 2");
        madeira2.setDados("2D10");
        madeira2.setDano(2);
        ARMAS.put(madeira2.getNome(), madeira2);
    ...
    public static Armas getArma(String nome) {
        return ARMAS.get(nome);
    }

    public static Armas getElemento(String nome) {
        return ELEMENTOS.get(nome);
    }
}
